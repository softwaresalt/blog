...
The EDM is a way of conceptually modeling the data that your application will use as described on [MSDN](https://msdn.microsoft.com/en-us/library/ee382825.aspx):
...
[The point of using the Entity Framework as an ORM](https://weblogs.asp.net/fbouma/archive/2008/05/19/why-use-the-entity-framework-yeah-why-exactly.aspx) is to achieve greater productivity, lower maintenance, and simplify development.  That being said, there are some principles behind why you would use an ORM in the first place.
